    ...
    return (
      <div>
        <div className="book__information">
          ...
          <Icons popId={this.props.popId} toggleDeletePopup={this.props.toggleDeletePopup} statePopUp={this.props.statePopUp} id={this.props.item.id} deleteBook={this.props.deleteBook} />
        </div>
