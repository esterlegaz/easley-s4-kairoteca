    ...
    return (
      <div>
        <div className="book__information">
          ...
          <Icons bookItemId={this.props.bookItemId} popId={this.props.popId} toggleDeletePopup={this.props.toggleDeletePopup} deletePopup={this.props.deletePopup} id={this.props.item.id} deleteBook={this.props.deleteBook} />
        </div>
